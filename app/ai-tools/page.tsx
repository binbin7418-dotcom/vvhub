    ...
    <main className="min-h-screen bg-gradient-to-br from-[#e0e7ff] via-[#f2f4ff] to-[#fafcff] font-sans text-gray-800">
      ...
      <section className="text-center mt-14 mb-12">
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          Discover the latest AI tools, tutorials, and prompts.
        </p>
        ...
        {data.ai_tools.map((item: any, i: number) => (
          ...
          >
            <div className="h-48 bg-gray-200 overflow-hidden">
              <img
                src={`https://picsum.photos/seed/ai${i}/600/400`}
                alt={item.title}
                loading="lazy"
